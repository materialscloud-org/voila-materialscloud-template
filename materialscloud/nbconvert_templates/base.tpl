...
<head>
  ...
  <link rel="shortcut icon" href="{{ resources.base_url }}voila/static/images/favicon.png" type="image/png" />

  <script src="{{ resources.base_url }}voila/static/js/jquery.min.js" type='text/javascript'></script>
  <script src="{{ resources.base_url }}voila/static/js/bootstrap.min.js" type='text/javascript'></script>

  {%- block html_head_js -%}
  <script
  src="{{resources.base_url}}voila/static/js/require.min.js"
